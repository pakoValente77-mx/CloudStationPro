...
{
  "ConnectionStrings": {
    "DefaultConnection": "Server=atlas16.ddns.net;Database=IGSCLOUD;User Id=sa;Password=Atlas2025$$;TrustServerCertificate=True;",
    "PostgreSQL": "Host=atlas16.ddns.net;Port=5432;Database=mycloud_timescale;Username=postgres;Password=Cfe123pass;"
  }
}
```
